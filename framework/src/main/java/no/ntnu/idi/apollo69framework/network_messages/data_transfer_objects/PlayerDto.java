...
public class PlayerDto {
    ...
    public PlayerDto(String playerId, String name, boolean alive, float hp, PositionDto positionDto, RotationDto rotationDto, VelocityDto velocityDto, boolean isVisible) {
